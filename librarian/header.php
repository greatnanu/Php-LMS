                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="books_details.php" > <i class="fa fa-bar-chart-o"></i> Books With All Info  <span
                                    class="fa fa-chevron-down"></span></a>

                            </li>
                            <li><a href="send_notification_student.php" > <i class="fa fa-mail-forward"></i> Inform To Student  <span
                                    class="fa fa-chevron-down"></span></a>
