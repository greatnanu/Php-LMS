                    ...
                    <div class="x_content">
                       <form method="post" action="" name="form1" class="col-lg-6" enctype="multipart/form-data">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td><input type="submit" name="submit1" value="Send Message" class="form-control"> </td>
                                </tr>
                            </table>
                        </form>
                    </div>
...
<?php
    if (isset($_POST['submit1'])) {
        mysqli_query($link , "insert into messages values ('','$_SESSION[librarian]','$_POST[dusername]','$_POST[title]','$_POST[msg]','n')") or die(mysql_error($link));
        ?>
        <script type="text/javascript">
